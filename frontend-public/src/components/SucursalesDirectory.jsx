...
const SUCURSALES_DATA = [
  ...
  },
  {
    ...
    comercioSlug: 'jumbo',
    color: '#008B45',
    nombre: 'Jumbo Trelew Mayorista',
    codigo: 'JUMBO_TRELEW',
    localidad: 'Trelew',
    provincia: 'Chubut',
    tipo: 'mayorista',
    direccion: 'Av. Hipólito Yrigoyen 1980, Trelew',
    descripcion: 'Packs por bulto cerrado, productos Cencosud importados y primeras marcas con IVA incluido.',
    destacado: 'Precios mayoristas y promo',
  },
  {
    id: 4,
    comercio: 'Vea',
